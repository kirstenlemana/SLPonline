...
if (isset($_POST['editid1'])) {
  $_SESSION['editid1'] = $_POST['editid1'];
  die("visitpage");
}
        $stmt = $db->prepare("SELECT * FROM fin_allotments WHERE allotid=:id ");
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>SLP | Finance Edit Fund Allotments</title>
          ...
          <div style="border:solid 1px #c5d6de;background:#fff;text-align:left;padding:0em;padding-left:1em;margin-bottom:2em;width:100%">
              ...
              <div class="row row-eq-height" >
                 <div class="col-md-6" style="background-color:#007ee5;padding:2em;color:#fff;">
                  SLP Finance System
                  <h3 style="margin-bottom:0">Edit Fund Allotments</h3>
                ...
                <div class="col-md-6" style="padding:3em;color:#000;padding-top:1em">
                  ...
                  <div class="form-group">
                        <select class="form-control" style="margin-bottom:0.5em" id="fundtype" name="fundtype">
                            <option><?php echo $rowa['type'];?></option> 
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-6" id="uacsholder">
                        <select class="form-control" id="uacs1" name="uacs1">
                            <option><?php echo $rowa['uacs'];?></option> 
                   ...
                   <div class="form-group">
                    <div class="row">
                      <div class="col-md-6">
                        <input class="form-control" name="amt" id="amt" placeholder="Amount (PhP)" value="<?php echo $rowa['amount'];?>"></input>
                      </div>
                      <div class="col-md-6">
                        <input class="form-control" name="d8" id="d8" placeholder="Date Accomplished" value="<?php echo $rowa['d8'];?>"></input>
                      </div>
                    </div>
                  </div>
  ...
  $.ajax({
       ...
       success: function(data)
       {
                if (data=="success") {
                      ...
                      $('#myModal').modal();
                      $('#myModal').on('hidden.bs.modal', function () {location.href = "allotments_view.php?id=<?php echo $_SESSION['pageid']; ?>"; });
                } else {
                      alert(data);
                }
